package com.htahmasebi.phototransfer.discovery
...
class ReceiverDiscovery(context: Context) {
    ...
    fun discover(): Flow<DiscoveryEvent> = callbackFlow {
        // NsdManager allows only one in-flight resolve; queue found services
        // and resolve them sequentially.
            ...
            nsdManager.resolveService(
                ...
                object : NsdManager.ResolveListener {
                    override fun onServiceResolved(resolved: NsdServiceInfo) {
                        ...
                        val device = host?.let {
                            ReceiverDevice(name = resolved.serviceName, host = it, port = resolved.port)
                        }
    ...
    companion object {
        const val SERVICE_TYPE = "_androidphototransfer._tcp"
    }
}
